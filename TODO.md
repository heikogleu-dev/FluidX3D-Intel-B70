...
| **4c** | **y-Halbzellen-Versatz des Fahrzeugs** (Heiko 16.09. 20:27: „mache diesen Versatz und starte neue") | **GEBAUT + Mechanismus abgenommen 16.09. 20:35** (`CFD_Y_VERSATZ`, Commit 91843b7): 8-mm-Probe iGPU — ohne: dy=±1 73,3 % Dicke-1-Wandzellen (Membran), mit: 0,6–1,1 % = Fahrzeugmittel (`werkzeuge/membran_y0.py`). Bei 3,75 mm ohne Versatz 82,2 % (p375_b) | **Läuft (Heiko 20:40: „direkt e mit Band und Versatz"):** `p375_e` = 3,75 mm + SGS-Band Lagen 2+3 + Versatz (`p375_d` als eigenmächtiger Bezugsarm abgebrochen). Vergleich gegen die vorhandenen Läufe p375_b/c; weiterer Arm nur nach Rückfrage. Danach Entscheid: Versatz in den Standard (Basis) |
