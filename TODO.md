...
| **4c** | **y-Halbzellen-Versatz des Fahrzeugs** (Heiko 16.09. 20:27) | **GEBAUT, geprüft, abgenommen 16.09.** (`CFD_Y_VERSATZ`, 91843b7 + Textfixes): Membran 8 mm 73,3 % → 0,8 %, 3,75 mm 82,2 % → 0,3 %. Prüfagent: 4 mm (`p4_register`) ist um ein ulp zufällig membranfrei → der 3,75↔4-mm-Vergleich vom Nachmittag war verunreinigt. `p375_e` (Band 2+3 + Versatz): Cd_rest −0,020 ± 0,006 (−4 %), Cz_rest +0,028 ± 0,016 (weniger Abtrieb, 1,8 σ), Laufzeit +4,4 %, VRAM-Min 2877 MiB | **Entscheide Heiko:** (a) Versatz in die Basis (Standard)? (b) ein Versatz-Lauf OHNE Band gegen p4_register, um Auflösung von Artefakt zu trennen? (c) Band bei 3,75 mm verwerfen (bewegt Cz nicht Richtung OF13)? |
