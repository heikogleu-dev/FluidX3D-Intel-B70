...
| **4** | **APG/Mozaffari-Linie fahren** (Todo 2) | **8 mm ERLEDIGT 16.09.** (A0/A1/A2, Befund oben). **4-mm-Voll-Lauf `p4_apg1` läuft seit 16.09. 13:11** (B70, Freigabe Heiko 13:10) | = `p4_pu8`-Zeile + `CFD_FAC_APG=1.0`, EINE Variable; κ=1 ist die herleitbare Variante, 0,5 ein Interim. Auswertung: Zeitreihentest `werkzeuge/zeitreihe_ab.py p4_pu8 p4_apg1` + Zähler [306..316] + Autoritätshistogramm. **Heikos Entscheid danach: bewegt es etwas oder nicht.** VRAM +55 MB (23 118 gegen 23 063 MB, Schlupf 7041 MB) |
