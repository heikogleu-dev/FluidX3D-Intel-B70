...
| **C2c** Aktivierung | Allokation R1 und Papierkorb, Emission, Konstruktor-Sperren, Rho_Feld-Fassade, `lese_yslice`, VTK-Schichten, VRAM-Vorprüfung, info.cpp, Bericht 204/205, `berichte_rho_rand`, Hostselbsttest, Lesestelle ohne C0-Abbruch, Sperren REK/AUSGABE_PRUEF, Haken 4–8 (Haken 3 ZURÜCKGESTELLT 15.09.: 0 asymmetrische MS-Zellen in Kugel und dd, der Haken wäre nicht trennscharf — gehört in den C2a-Prüfarm, sobald ein Fall solche Zellen hat) | CPU, dann iGPU, dann B70 kurz. 0 Errors; 216 = 0; 219/220/204/205 Ist=Soll; Verify-Deckungspunkte wie HEAD; `memory_used` Nahfeld −120 MiB (8 mm); alle Haken feuern |
