...
public:
	...
	Memory<uint> rho_clamp_hits; // FEST 66 Slots. Legende steht an EINER Stelle: lbm.cpp bei der Allokation (Pruefbefund 3-E: hier stand eine widerspruechliche Zweitfassung, aus der der naechste Slot vergeben worden waere).
	...
	static float s_fac_qkappe; // Stabilitaetskappe q>0,5 (Interim)
