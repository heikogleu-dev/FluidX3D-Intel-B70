...
public:
	...
	Memory<uint> rho_clamp_hits; // 30 Slots immer, 49 mit CFD_SGS_DIAG. Legende ([29] SPONGE-Wirkpfad inkl. Klemme, [28] Geschwindigkeitsklemme -- beide 2026-08-25 ergaenzt, weil sie die EINZIGEN Mechanismen ohne feuernden Zaehler waren; [0/1] RHO_CLAMP sind seit 2026-08-25 GEGATET (t%100) -- vorher wickelten sie nach rund 21 Schritten, aeltere Zahlen sind NICHT quantitativ) ([28..32] nu_t/nu_0-DEKADENHISTOGRAMM der Smagorinsky-Wirbelviskositaet, Grenzen 1/10/100/1000, t%100 -- ein omega-Histogramm waere blind, weil beide Gitter schon bei omega=1,9999 stehen; die Zahl entscheidet den SGS-Hebel, GRENZSCHICHT-SGS-PLAN.md) ([27] Slot-13-SPLIT: Teilmenge von [13] mit ROHEN Tangentialmomenten > 0 -- die Einzellink-Diagonal-Klasse, die das ALPHA2-Downdate analytisch entkoppelt; [13] minus [27] = reine c-parallel-n-Zellen. Bemisst den Ertrag von ELIBB/Punkt 1c, physikfrei, t%100) ([26] Mass des N2F-PAARUNGSBEWEISES in 1e-9-Schritten, [25] Zahl der Zell-Stichproben, in denen die Momente aus ftrue die aus fhn NICHT negieren -- der echte Test der EsoPull-Paarung; die Slots 23/24 darunter sind gegen Paarungs- und Momentenfehler STRUKTURELL BLIND (sie vergleichen x+(y-x) gegen y, beides kuerzt sich heraus) und messen nur Rundung, Pruefagent-Befund 2026-08-22) ([23] N2F-Blend-PARITAETSZAEHLER: Zahl der gespeicherten Werte, die vom geladenen abweichen -- bei a==0 MUSS er 0 sein (geraeteinterner Beweis, weil ein Datei-Bitvergleich im dd-Fall unmoeglich ist: die Aktivierung macht das Fernfeld ueber po_mean nichtdeterministisch, gemessen 2026-08-22); [22] N2F-SCHALE-Blend-Wirkpfad (t%100, P9c); [21] EINLASS_EQ-Wirkpfad (t%100); [20] BODEN_EQ-Wirkpfad (t%100); 3x3-Iteration: [14] gekoppelter Rang-2, [15] gekoppelt Rang 0 -> BB, [16] s_n-Klemme/Gate-Rueckfall (t%100), [17] PEMA-utb-Fallback (t%100), [18] alpha>u_t (nur ALPHA-Arm, t%100), [19] APG-Klemme unten 0 ODER oben 2*tw (nur APG-Arm, t%100)): [0/1] RHO_CLAMP unten/oben, [2] WFB-Wirkpfad (t%100), [3] tau-Klemme (t%100), [4] u_t~0-Skips (t%100), [5] Ein-Zellen-Spalt (t%100; alle drei seit Gross-Audit gegen uint-Wickel gegatet), [6] SGS_WANDFREI-Wirkpfad (t%100), [7] Facetten-Wirkpfad (t%100), [8] Facetten-tau-Klemme (t%100, beide Klemmen), [9] Facetten-u_t~0-Skip (t%100), [10] u_s-Klemme (iMEM, t%100; die alte Achskonflikt-Reservierung entfiel -- Stufe 4 ist unter iMEM obsolet), [11] ohne offenes Paar (nur Paararm, t%100), [12] iMEM-Skalar-Fallback (t%100), [13] iMEM ohne tangential wirksamen Link (t%100)
