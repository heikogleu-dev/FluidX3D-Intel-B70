...
void main_setup_kanal() {
	...
	if(env_u("CFD_FACETTEN", 0u)>0u) {
		...
		lbm.alloc_facetten(FF, nullptr, env_u("CFD_SGS_GDIAG", 0u), env_u("CFD_SGS_FDWAND", 0u), env_u("CFD_SGS_SISM", 0u)); zensus_statische_klassen(lbm, FF, Nx, Ny, Nz, TYPE_S, (env_u("CFD_FACETTEN",0u)>=3u&&env_u("CFD_FAC_ALPHA",0u)>=2u&&env_u("CFD_FAC_MASSE_ALLE",0u)==0u), "Kanal", out_dir); // Parameter statt Statik (02.09.)
