...
// #define WALL_MODEL_VEHICLE // 2026-05-15 DISABLED AGAIN — Multi-Res test failed catastrophically: Fx_far=292k N + Fx_near=346k N (500× target) in BOTH domains nach 3 chunks. Three-Attractor Pathology (CC#11 finding 36) reproduziert — User's Near-only Idee gettestet implizit (Near hat 346k → auch dort kaputt). WW-Krüger ist fundamental inkompatibel mit aktueller MR2-STL Geometrie unabhängig von Resolution. Pivot zu Wall Function (Han 2021) als nächster Wandmodell-Pfad.
