> **This file is the development narrative, moved out of `README.md` on 2026-09-23.**
> It is kept verbatim because the measurements, the rejected arms and the dated reasoning are the
> evidence behind the README's claims. It is *not* the project description — that is
> [README.md](README.md). Entries are newest-first; the day-by-day detail lives in
> `wissensspeicher-tagesprotokoll/`.
