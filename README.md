...
| **5b (same-res Mechanik-Test)** | Two-LBM-instance same-res Schwarz coupling auf single GPU (Far 225M + Near 38.85M) | mittel | ⚠️ **2026-05-13 BORDERLINE**: Mechanik PASS (two LBMs koexistieren, 5 Coupling-Planes/chunk OK), Drag-Match Δ +14.3% (>10% strict, <2σ). Hypothesis: Near-Blockage 36% + Wake 0.44 L. See [`findings/PHASE_5B_DUAL_DOMAIN_RESULT_2026-05-13.md`](findings/PHASE_5B_DUAL_DOMAIN_RESULT_2026-05-13.md) for 4 paths forward (vergrößern / Wake-Verlängerung / Back-Coupling / Phase 5c). |
| **5b-DR** | Double-Res Schwarz Coupling (Far @ 20mm, Near @ 10mm) mit Pure-BB | mittel-hoch | 🟢 **Hauptpfad (next nach 5b Resolution-Entscheidung)** |
