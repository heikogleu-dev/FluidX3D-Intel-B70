...
- **Phase 5b Dual-Domain Same-Resolution Coupling** (2026-05-13): NEW `#define PHASE_5B_DUAL_DOMAIN` toggle and `void main_setup_phase5b_dual()` function (~120 lines in setup.cpp). Instantiates two independent LBM instances on single GPU: Far 1000×500×450 = 225 M cells (10m × 5m × 4.5m @ 10 mm, shrunk from CC#6-Full per user 2026-05-13 to reduce runtime, X anlauf 1.25m, X wake 4.25m, blockage 8.9%) + Near 700×300×185 = 38.85 M cells (7m × 3m × 1.85m @ 10 mm, compact around vehicle: 0.5m vor/sides/top, 2m wake). 5 Coupling-Planes Far→Near per chunk (X_min, X_max, Y_min, Y_max, Z_max). GPU memory measured: Far 14.4 GB + Near 2.5 GB = ~17 GB on Arc Pro B70 (32 GB total). 15000-step run (19.5 min wallclock) showed **BORDERLINE result:** Fx_far 1730 N ± 139 N vs Fx_near 1977 N ± 143 N, Δ +14.3% (>10% strict cutoff but within 2σ combined). Hypothesis: Near's high blockage (Vehicle/Near-Querschnitt = 36%) + short wake (0.44 L < required 3 L) inflates Near drag. Two-LBM-instance mechanics PASS, drag-match physics-limited. See `findings/PHASE_5B_DUAL_DOMAIN_RESULT_2026-05-13.md` for full analysis + 4 paths forward.
